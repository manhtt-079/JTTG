...
class T5GenerationHead(nn.Module):
...
class T5Sum(nn.Module):
    
    def __init__(self, conf: ModelConf) -> None:
        super(T5Sum, self).__init__()
        ...
        self.generator_head = T5GenerationHead(self.model.config.d_model, self.model.shared.num_embeddings)
