...
class ExAbTrainer(Seq2SeqTrainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        input_ids, attention_mask, decoder_input_ids, decoder_attention_mask, sent_rep_ids, sent_rep_mask, label = inputs
        outputs: Tuple[torch.Tensor, torch.Tensor] = model(input_ids=input_ids,
